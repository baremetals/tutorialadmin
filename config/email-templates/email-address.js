...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color:#f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
	      ...
	      <tr>
          <td valign="middle" class="hero bg_white" style="background:#5634bf; background-size: cover; height:200px;">
          	<div class="overlay"></div>
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 0em; text-align: center;">
            				<h2 style="padding-bottom:20px; font-size:20px;">Email verification required</h2>
            				<p><a href="<%= URL %>?confirmation=<%= CODE %>" style="background:#fff; color:#000; padding:12px 30px; border-radius:20px; font-weight:600;">Verify email</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left; color:#000;">
            				...
            				<p>Before we can move forwared with your account we first need you o verify your email address.</p>
                            <p>Thanks, <br /> Team BM's</p>
            			</div>
            		</td>
            	</tr>
            </table>
            ...
            <table>
                ...
                <td valign="middle" width="20%" style="padding-top:0px; text-align: right;">
                	<ul style="" class="social">
                        <li style="margin-bottom:0; vertical-align: middle; padding:0 4px"><a href="https://www.linkedin.com/in/daniel-asante-205504127"><img src="https://storage.googleapis.com/baremets_tutor/linkedin_icon_06d65d8cd9/linkedin_icon_06d65d8cd9.png?updated_at=2022-02-24T12:58:26.690Z" alt="" style="width:18px;"  /></a></li>
                         <li style="margin-bottom:0; vertical-align: middle; padding:0 4px"><a href="https://twitter.com/bare_academy"><img src="https://storage.googleapis.com/baremets_tutor/twitter_icon_59c92aac4b/twitter_icon_59c92aac4b.png?updated_at=2022-02-24T12:58:40.344Z" alt="" style="width:18px;" /></a></li>
                    </ul>
                </td>
              </tr>
            </table>
