            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 0em; text-align: center;">
            				...
            				<p><a href="<%= URL %>?code=<%= TOKEN %>" style="background:#fff; color:#000; padding:12px 30px; border-radius:20px; font-weight:600;">Click me</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: left; color:#000;">
                            ...
                            <p>But don’t worry! You can use the following button above to reset your password:</p>
